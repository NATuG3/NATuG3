...
class Panel(QWidget):
    ...
    def __init__(self, parent) -> None:
        ...
        uic.loadUi("constructor/panels/nucleic_acid/panel.ui", self)
        ...
        self.dump_settings(references.nucleic_acid.current)
    ...
    def _profile_manager(self):
        ...
        def save_profile(self):
            ...
            references.nucleic_acid.profiles[profile_name] = self.fetch_settings()
        ...
        def delete_profile(self):
            ...
            assert profile_name in references.nucleic_acid.profiles
            del references.nucleic_acid.profiles[profile_name]
        ...
        def load_profile(self):
            ...
            self.dump_settings(references.nucleic_acid.profiles[profile_name])
        ...
        def input_box_changed():
            ...
            self.Z_b.setValue(references.nucleic_acid.current.Z_b)
            ...
            if chosen_profile_name in references.nucleic_acid.profiles:
                ...
                if chosen_profile_name in references.nucleic_acid.defaults:
                    self.save_profile_button.setEnabled(False)
                    self.save_profile_button.setToolTip("Save Profile")
                    self.save_profile_button.setStatusTip(
        ...
        def hook_widgets():
            ...
            for profile_name in references.nucleic_acid.profiles:
                self.profile_chooser.addItem(profile_name)
