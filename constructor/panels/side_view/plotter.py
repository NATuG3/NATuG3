...
from PyQt6.QtWidgets import QDialog, QVBoxLayout, QLabel, QFormLayout, QDoubleSpinBox, QAbstractSpinBox, QGridLayout
            ...
            for item in located:
                ...
                if isinstance(item, NEMid):
                    ...
                    dialog.original_domain.setText(
                        f"domain #{item.domain.index+1} of {references.domains.current.count} domains"
                    )
