...
class panel(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.tabs.append(config.nucleic_acid.panel(self))
        self.nucleic_acid_tab.setLayout(QVBoxLayout())
        self.nucleic_acid_tab.layout().addWidget(self.tabs[-1])

        # set the domains tab
        # store actual widget in the tabs container
        self.tabs.append(config.domains.panel())
        self.domains_tab.setLayout(QVBoxLayout())
        self.domains_tab.layout().addWidget(self.tabs[-1])
