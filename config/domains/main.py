...
class panel(QWidget):
    ...
    def __init__(self) -> None:
        ...
        # main area where domains are stored is a scroll area
        # with a vertical array layout
        self.domains_area.setLayout(QVBoxLayout())
    ...
    def dump_domains(self, domains_list):
        ...
        for index, domain in enumerate(domains_list):
            self.domains_area.layout().addWidget(
